...
<form>
	<p class="p"> Latest All Posts </p><br>
	<p class="p"> --------Headlins-------------Post----------------Posted by-------------Date--------------Category </p>
<?php 

$jsonDataEdit= getJSONFromDB("SELECT * FROM POST_TAB ORDER BY POST_ID ASC"); 
...
<br> 
    ...
    <input type="" name="" value="<?php echo $jsndata[$j]['DATE_TIME']  ; ?>"> 
     ...
     <input type="" name="" value="<?php echo $jsndata[$j]['CATEGORIES']  ; ?>"> 
